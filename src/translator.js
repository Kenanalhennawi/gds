...
export const translateSSR = (text) => {
  ...
  if (t.includes("ADTK") || t.includes("TIME LIMIT") || t.includes("TKT BY")) {
    return { title: "Ticket Time Limit", msg: "Tickets must be issued by the deadline or booking will be cancelled.", type: "warning" };
  }
  ...
  if (t.includes("SPLIT") || t.includes("DIVIDE") || t.includes("DVD")) {
    return { title: "PNR Split", msg: "Passengers moved to new record.", type: "info" };
  }
