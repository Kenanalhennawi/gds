...
const OTHER_SECTIONS_QA = [
    ...
    // --- Named tab Q&A (e.g. "Sports tab", "Reporting tab") ---
    { keywords: ['excess baggage tab', 'excess tab'], answer: `**Excess Baggage tab:** Enter **origin**, **destination**, **airline** (FZ, EK, OAL, UA, AC), and **currency**. Click **Calculate** for per-kg or flat rate. Route exceptions (CMB–MLE, India, LCA–MLA) shown when applicable.` },
    { keywords: ['go-show tab', 'goshow tab', 'go show fares tab'], answer: `**Go-Show Fares tab:** Enter **origin airport** and **class** (Economy or Business). Click **Calculate**. Result shows **adult** and **infant** one-way fare for that origin and class.` },
    { keywords: ['sports equipment tab', 'sports tab'], answer: `**Sports Equipment tab:** Select **currency** and **equipment type** (SPEQ Standard or SPEX Oversized). Click **Calculate** for the rate.` },
    { keywords: ['reporting fees tab', 'reporting tab'], answer: `**Reporting Fees tab:** Select **currency** and **fee type** (LRTP Late Reporting or ERTP Early Reporting). Click **Calculate** for the fee.` },
    { keywords: ['transfer baggage tab', 'transfer tab'], answer: `**Transfer Baggage tab:** Select **location** (DXB – Dubai or Outstation). Rate shown: DXB AED 50 + GHA AED 50; Outstation USD 30 + GHA. SSR code TRBF.` },
    { keywords: ['upgrade to business tab', 'upgrade tab'], answer: `**Upgrade to Business tab:** Enter **origin airport** and **currency**. Click **Calculate**. Result shows at-airport rate, on-board rate, and infant rate (when available); exception rate if origin has one (KWI, BAH, MCT, Saudi, India, etc.).` },
    { keywords: ['extra legroom tab', 'legroom tab', 'extralegroom tab', 'xlgr tab'], answer: `**Extra Legroom tab:** Select **currency**. Result shows **airport rate** and **on board rate**; currency exchange to USD where available.` },
    { keywords: ['reference tab'], answer: `**Reference tab:** Read-only. Contains: **Interline** table (which carrier's rates apply), **customer disclaimer**, FS/SUP note, **Aircraft & XLGR** table (Page 26), **EK/OAL** and **UA/AC** excess text, **regional classification** (country list).` },
    { keywords: ['ask agent tab', 'agent tab', 'this tab'], answer: `**Ask Agent tab:** This tab. Type a question (e.g. interline, excess baggage, upgrade, go-show, sports, reporting, transfer, legroom, reference) and click **Ask** for an answer from the GO-SHOW/UPGRADE/EXCESS BAGGAGE RATES reference.` },
    // --- Go-Show section ---
    {
